...
class livepokertest(BaseTestCase, unittest.TestCase):
    ...
    def testVerify_text_Sortby_is_existing_in_OtherGames_Pagetest(self):
        ...
        if (name == 'Sort by:'):
            print("Pass!")
        bj_page_obj.appendtofile(2, "OtherGames Game Stake Size text is existing:")
    ...
    def testVerify_text_ZA_changes_to_AZ_by_clicking_in_OtherGames_Pagetest(self):
        ...
        if (name == 'A-Z'):
            print("Pass!")
        bj_page_obj.appendtofile(2, "OtherGames Game Z-A changes to A-Z for sorting:")
    ...
    def testVerify_text_AZ_changes_to_ZA_by_clicking_in_Page_OtherGamestest(self):
        ...
        if (name == 'Z-A'):
            print("Pass!")
        bj_page_obj.appendtofile(2, "OtherGames Game A-Z changes to Z-A for sorting:")
    ...
    def testVerify_text_AZ_is_existing_in_OtherGames_Pagetest(self):
        ...
        if(name=='A-Z'):
            print("Pass!")
            bj_page_obj.appendtofile(2,"OtherGames Game A-Z existing for sorting:")
