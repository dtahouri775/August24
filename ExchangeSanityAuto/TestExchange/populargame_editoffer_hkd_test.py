...
class popularpagetest(BaseTestCase, unittest.TestCase):
    ...
    def testsubmitEdit_BackOdds_offer_hkd(self):
        ...
        time.sleep(1)
    def testsubmitEdit_BackOddsStake_offer_hkd(self):
    ...
    def testsubmitEdit_BackStake_offer_hkd(self):
    ...
    def testsubmitEdit_LayOdds_offer_hkd(self):
        ...
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_LayStake_offer_hkd(self):
        ...
        sg_page_obj.cancel_unmatched()
    def testsubmitEdit_LayOddsStake_offer_hkd(self):
        ...
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_WinOdds_offer_hkd(self):
    ...
    def testsubmitEdit_WinStake_offer_hkd(self):
    ...
    def testsubmitEdit_WinOddsStake_offer_hkd(self):
    ...
    def testsubmitEdit_LoseStake_offer_hkd(self):
    ...
    def testsubmitEdit_LoseOdds_offer_hkd(self):
    ...
    def testsubmitEdit_LoseOddsStake_offer_hkd(self):
