...
class popularpagematchbettest(BaseTestCase, unittest.TestCase):
    ...
    def testsubmitwin_lose_offer_match_Aud(self):#This test is going to be completed next week!

            sg_page_obj = MainPage(self.driver)
            sg_page_obj.click_logintop_button("aud2_match1")#make bet on win
            backnumber="2.0"
            stakenumber = "40"
            time.sleep(1)
            ...
            sg_page_obj.click_logintop_button("aud3_match1")  # make bet on lose
            backnumber = "2.0"
            stakenumber = "10"
            time.sleep(4)
            ...
            time.sleep(2)
            sg_page_obj.logout()
    def testsubmitwin_lose_offer_match_Eur(self):#This test is going to be completed next week!

            sg_page_obj = MainPage(self.driver)
            sg_page_obj.click_logintop_button("eur_match1")#make bet on win
            backnumber="2.0"
            stakenumber = "40"
            time.sleep(1)
            sg_page_obj. submit_request_winoffer_match(backnumber,stakenumber,2)
            ...
            sg_page_obj.click_logintop_button("eur_match2")  # make bet on lose
            backnumber = "2.0"
            stakenumber = "10"
            time.sleep(4)
            sg_page_obj.submit_request_loseoffer_match(backnumber,stakenumber)
    ...
    def testsubmitwin_lose_offer_match_Gbp(self):  # This test is going to be completed next week!

        sg_page_obj = MainPage(self.driver)
        sg_page_obj.click_logintop_button("gbp1_match1")  # make bet on win
        backnumber = "2.0"
        stakenumber = "40"
        time.sleep(1)
        sg_page_obj.submit_request_winoffer_match(backnumber, stakenumber, 2)
        ...
        sg_page_obj.click_logintop_button("gbp2_match1")  # make bet on lose
        backnumber = "2.0"
        stakenumber = "10"
        time.sleep(4)
        sg_page_obj.submit_request_loseoffer_match(backnumber, stakenumber)
