...
class popularpagetest(BaseTestCase, unittest.TestCase):
    ...
    def testsubmitEdit_BackOdds_offer_cad(self):
        ...
        time.sleep(1)
    def testsubmitEdit_BackOddsStake_offer_cad(self):
    ...
    def testsubmitEdit_BackStake_offer_cad(self):
    ...
    def testsubmitEdit_LayOdds_offer_cad(self):
        ...
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_LayStake_offer_cad(self):
        ...
        sg_page_obj.cancel_unmatched()
    def testsubmitEdit_LayOddsStake_offer_cad(self):
        ...
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_WinOdds_offer_cad(self):
    ...
    def testsubmitEdit_WinStake_offer_cad(self):
    ...
    def testsubmitEdit_WinOddsStake_offer_cad(self):
    ...
    def testsubmitEdit_LoseStake_offer_cad(self):
    ...
    def testsubmitEdit_LoseOdds_offer_cad(self):
    ...
    def testsubmitEdit_LoseOddsStake_offer_cad(self):
