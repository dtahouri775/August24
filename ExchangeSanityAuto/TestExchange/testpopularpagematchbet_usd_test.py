...
class popularpagematchbettest(BaseTestCase, unittest.TestCase):
    ...
    def testsubmitwin_lose_offer_match_usduser(self):#This test is going to be completed next week!

            sg_page_obj = MainPage(self.driver)
            sg_page_obj.click_logintop_button("usd2_match1")#make bet on win
            backnumber="2.0"
            stakenumber = "40"
            time.sleep(1)
            ...
            sg_page_obj.click_logintop_button("usd3_match1")  # make bet on lose
            backnumber = "2.0"
            stakenumber = "10"
            time.sleep(4)
