...
class popularpagetest(BaseTestCase, unittest.TestCase):
    ...
    def testsubmitEdit_BackOdds_offer_gbp(self):
        ...
        if (profit == "8.93"):
            ...
            print"Fail: The Calculation of profit may not be correct"
        ...
        if (profit == "9.26"):
            ...
            print"Fail: The updated bet value of profit may not be correct"

        time.sleep(1)
            # Cancel the bet slip
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_BackOddsStake_offer_gbp(self):
    ...
    def testsubmitEdit_BackStake_offer_gbp(self):
    ...
    def testsubmitEdit_LayOdds_offer_gbp(self):
        ...
        if (profit == "8.93"):
            ...
            print"Fail: The edit value of profit my not be correct"

        time.sleep(1)
        # Cancel the bet slip
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_LayStake_offer_gbp(self):
        ...
        if (newprofit !=  profit):
            ...
            print"Fail: The edit value of profit my not be correct when both stake and lay are edited"

        time.sleep(1)

        sg_page_obj.cancel_unmatched()
    def testsubmitEdit_LayOddsStake_offer_gbp(self):
        ...
        if (newprofit !=  profit):
            ...
            print"Fail: The edit value of profit may not be correct when both stake and lay are edited"

        time.sleep(1)
        # Cancel the bet slip
        sg_page_obj.cancel_unmatched()
        time.sleep(1)
    def testsubmitEdit_WinOdds_offer_gbp(self):
    ...
    def testsubmitEdit_WinStake_offer_gbp(self):
    ...
    def testsubmitEdit_WinOddsStake_offer_gbp(self):
    ...
    def testsubmitEdit_LoseStake_offer_gbp(self):
    ...
    def testsubmitEdit_LoseOdds_offer_gbp(self):
    ...
    def testsubmitEdit_LoseOddsStake_offer_gbp(self):
