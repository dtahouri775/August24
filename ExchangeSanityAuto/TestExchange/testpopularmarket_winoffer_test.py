...
class popularpagetest(BaseTestCase, unittest.TestCase):
    ...
    def testsubmitwinofferEurouser(self):
    ...
    def testsubmitwinofferGbpuser(self):
    ...
    def testsubmitwinofferCaduser(self):
    ...
    def testsubmitwinofferAudduser(self):
    ...
    def testsubmitwinofferHkdduser(self):
    ...
    def testsubmitwinofferUsdduser(self):
